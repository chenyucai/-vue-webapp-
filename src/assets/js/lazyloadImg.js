...
!(function (LazyloadImg) {
    ...
    function LazyloadImg(myset) {
        ...
        */
        ...
        //监听的事件列表
        // 增加 hashchange 监听路由变化
        this.monitorEvent = ['DOMContentLoaded', 'load', 'click', 'touchstart', 'touchend', 'haschange', 'online', 'pageshow', 'popstate', 'resize', 'storage', 'mousewheel', 'scroll', 'hashchange'];
